    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          "https://acaderealty.com/fetch-data?user=" + nameParam
        );
                    ...
                    {data.length > 0 ? (
                      data.map((email, index) => (
                        <tr key={index}>
                          ...
                          <td className="fw-bold text-center orangeText">
                            {email.Opens || 0}
                          </td>{" "}
                          {/* Add Opens logic */}
                          <td className="fw-bold text-center greenText">
                            {email.Clicks || 0}
                          </td>{" "}
                          {/* Add Clicks logic */}
                          <td className="fw-bold text-center skyBlueText">
                            {email.unsubscribed || 0}
                          </td>{" "}
                          {/* Add Unsubscribed logic */}
                          <td className="fw-bold text-center purpleText">
                            {email.Bounced || 0}
                          </td>{" "}
                          {/* Add Bounces logic */}
                          ...
                          {/* Add Replies logic */}
                          <td className="fw-bold text-center redText">
                            N/A
                          </td>{" "}
                          {/* Add Blocks logic */}
                          <td className="fw-bold text-center greenText">
                          ...
                          {/* Add Auto Follow-Up logic */}
                          <td className="text-center">N/A</td>{" "}
                          {/* Add Sends Next logic */}
